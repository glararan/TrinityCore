...
enum WorldTimers
{
    ...
    WUPDATE_DELETECHARS,
    WUPDATE_PINGDB,
	WUPDATE_RP_LEVELING, // RP LEVELING
    WUPDATE_COUNT
};
...
enum WorldBoolConfigs
{
	...
	CONFIG_RP_LEVELING, // RP LEVELING
	CONFIG_RP_LEVELING_MSG, // RP LEVELING
...
enum WorldIntConfigs
{
	...
	CONFIG_RP_LEVELING_CHECK_INTERVAL, // RP LEVELING
	CONFIG_RP_LEVELING_INTERVAL_FOR_LEVEL, // RP LEVELING
